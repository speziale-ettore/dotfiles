...
--The following edits allows to correct the yearly delay
  --Edit wlourf : convert minutes into fractions of hour
  if pt['arg'] == "%I.%M"  then
  ...
  --Edit Fenouille84 : convert seconds into fractions of minute
  if pt['arg'] == "%M.%S"  then
